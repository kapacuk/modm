...
/// @ingroup modm_driver_st7735
template <class Interface, class Reset, std::size_t BufferSize = 320>
class St7735 : public Interface, public modm::ColorGraphicDisplay
{
	...
	using Command = st7735::Command;
public:
	static constexpr uint16_t Area = Width * Height;
	using Orientation = glcd::Orientation;
	using DisplayMode = st7735::DisplayMode;

	template<typename... Args>
	St7735(Args&&... args): Interface(std::forward<Args>(args)...)
	{
    ...
    // TODO implement getPixel for st7735
	color::Rgb565
...
#include "st7735_impl.hpp"

#endif //  MODM_ST7735_HPP
